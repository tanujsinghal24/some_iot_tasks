...
float vl= 0.25642449+0.79570074*(distance)-0.220585*(distance*distance)+ 0.02222868*(distance*distance*distance)+6.500;
float vr=-0.02069927+ 1.25771138*(distance) -0.42779086*(distance*distance)+0.04796109*(distance*distance*distance)+6.500;
vl=vl*100;
vr=vr*100;
